...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", 26813404)
    API_HASH  = os.environ.get("API_HASH", "8651f6b4cc04b5fff1fda3ac7488b114")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8220312376:AAEFc7BvFCYI6K0XXnd1hXH2eE2heJGrEoQ")
    ...
    FORCE_SUB_1 = os.environ.get("FORCE_SUB_1", "-1002949135839")
    FORCE_SUB_2 = os.environ.get("FORCE_SUB_2", "-1001958478348")
...
✨ ᴛʜɪs ʙᴏᴛ ɪs ᴄʀᴇᴀᴛᴇᴅ ʙʏ <a href=tg://openmessage?user_id=7793156995>ɢᴏᴋᴜ</a>
──────────────────
...
#⚠️ Dᴏɴ'ᴛ Rᴇᴍᴏᴠᴇ Oᴜʀ Cʀᴇᴅɪᴛꜱ @Og_Goku_God_7🙏🥲
    ABOUT_TXT = """<b>
» ᴅᴇᴠᴇʟᴏᴩᴇʀ : <a href=https://t.me/Og_goku_God_7>ɢᴏᴋᴜ</a>
» ɢɪᴛʜᴜʙ :  <a href=/>ʟᴜꜰꜰʏ</a>
» ʟɪʙʀᴀʀʏ : <a href=https://github.com/pyrogram>ᴘʏʀᴏɢʀᴀᴍ</a>
» ʟᴀɴɢᴜᴀɢᴇ: <a href=https://www.python.org>ᴘʏᴛʜᴏɴ</a>
» ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ : <a href=ht>ʀᴀᴢᴇ ʀᴇɴᴀᴍᴇʀ ʙᴏᴛ</a>
» ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ : <a href=https://t.me/Eternal_society>ᴇᴛᴇʀɴᴀʟ ꜱᴏᴄɪᴇᴛʏ</a>
» ᴍᴀɪɴ ɢʀᴏᴜᴘ : <a href=https://t.me/sorcerers_680>ᴋᴏɴᴏʜᴀ ᴠɪʟʟᴀɢᴇ</a></b>"""
